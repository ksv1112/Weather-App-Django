...
def index(request):
    ...
    API_KEY = open("copied_path","r").read()   # Paste the absolte path of API_KEY
...
def fetch_weather_and_forecast(city, api_key, current_weather_url, forecast_url):
    ...
    # else:
    #     # Handle the case where 'daily' key is not present in forecast_response
    #     return 'No daily forecast data available', 'No daily forecast data available'
